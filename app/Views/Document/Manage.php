                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-2 col-form-label">Current Workspace</label>
                                <div class="col-md-10">
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="current-folder" class="col-md-2 col-form-label">Current Workspace</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label">Destination Workspace</label>
                                <div class="col-md-10">
