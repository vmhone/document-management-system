    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="page-title mb-0 font-size-18">Create New Folder</h4>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Folder Details</h4>
                    <p class="card-title-desc">Provide the details of the folder</p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <div>
                                <button onclick="CreateFolder();" name="btnCreate" id="btnCreate" type="submit" class="btn btn-primary waves-effect waves-light width-md">Create Folder</button>
                            </div>
                        </div>
                    </div>
