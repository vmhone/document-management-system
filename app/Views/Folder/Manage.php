...
<div>
    <div id="folderDetailsModal" class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myExtraLargeModalLabel">Folder Details</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="row">
                                    ...
                                    <div class="tab-pane show active" id="folderdetails">
                                        <div class="row">
                                            <div class="col-md-4 col-12">
                                                <h6><i class="fas fa-folder"></i> Folder Name</h6>
                                                <div id="FolderName"></div>
                                                <div>&nbsp;</div>

                                                <h6><i class="fas fa-user-tie"></i> Folder Owner</h6>
                                                <div id="FolderOwner"></div>
                                                <div>&nbsp;</div>

                                                <h6><i class="fas fa-info-circle"></i> Folder Status</h6>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            <div id="modifyModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Modify Folder</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-md-2 col-form-label">Folder Name</label>
                                <div class="col-md-10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div>
                                        <button onclick="ConfirmModify();" name="btnModify" id="btnModify" type="submit" class="btn btn-primary waves-effect waves-light width-md">Modify Folder</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-sm-6 col-md-4 col-xl-3">
            <div id="renameModal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title mt-0" id="myLargeModalLabel">Rename Folder</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">Manage Folder</h4>
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Folder Management</h4>
